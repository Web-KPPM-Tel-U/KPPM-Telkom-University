...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden bg-white">
      ...
      <div
        className="relative z-10 w-full max-w-5xl flex rounded-3xl overflow-hidden"
        style={{
          minHeight: '600px',
          ...
          <div className="mb-8">
            <div className="flex items-center gap-5 mb-6">
              ...
              <div className="flex flex-col justify-center">
                <h2 className="font-black text-gray-900 text-[22px] leading-tight tracking-tight uppercase whitespace-nowrap" style={{ letterSpacing: '0.01em' }}>
                  Sistem Manajemen KPPM
                </h2>
                <p className="text-[#CC0000] text-[14px] font-extrabold tracking-widest mt-0.5 uppercase" style={{ letterSpacing: '0.08em' }}>
                  Telkom University
                </p>
              </div>
            </div>

            <h1 className="text-[32px] font-extrabold text-gray-900 tracking-tight leading-tight">Portal Admin</h1>
