...
exports.getMentorDashboard = void 0;
...
const getMentorDashboard = async (req, res) => {
    ...
    const registrationId = req.user?.registration_id;
    if (!mentorEmail) {
    ...
    try {
        ...
        const [regRows] = (await db_1.default.execute(`SELECT
         ir.registration_id,
         ir.status,
         ir.company_name,
       ...
       ORDER BY ir.approved_at DESC`, [mentorEmail]));
