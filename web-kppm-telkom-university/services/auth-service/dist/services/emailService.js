...
exports.sendForgotPasswordOtpEmail = exports.sendLecturerVerifyOtpEmail = exports.sendStudentVerifyOtpEmail = exports.sendOtpEmail = void 0;
 ...
 */
const sendStudentVerifyOtpEmail = async (toEmail, otp) => {
    const from = process.env.EMAIL_FROM || `"KPPM Telkom University" <${process.env.SMTP_USER}>`;
    const mailOptions = {
        from,
        to: toEmail,
...
exports.sendStudentVerifyOtpEmail = sendStudentVerifyOtpEmail;
/**
 * Kirim email OTP verifikasi ke dosen (Pembimbing Akademik)
 */
const sendLecturerVerifyOtpEmail = async (toEmail, otp) => {
    const from = process.env.EMAIL_FROM || `"KPPM Telkom University" <${process.env.SMTP_USER}>`;
    const mailOptions = {
        from,
        to: toEmail,
...
exports.sendLecturerVerifyOtpEmail = sendLecturerVerifyOtpEmail;
/**
 * Kirim email OTP untuk Lupa Password (Mahasiswa)
 */
const sendForgotPasswordOtpEmail = async (toEmail, otp) => {
    ...
    const mailOptions = {
        from,
        to: toEmail,
        subject: 'Kode OTP Lupa Password — KPPM Telkom University',
        html: `
      <!DOCTYPE html>
      <html lang="id">
      <head>
          ...
          <tr>
            <td align="center">
              <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
                ...
                <tr>
                  <td style="padding:36px 40px;">
                    <p style="margin:0 0 6px;font-size:13px;color:#6b7280;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;">Pemulihan Akun</p>
                    <h1 style="margin:0 0 20px;font-size:22px;font-weight:800;color:#111827;">Lupa Password</h1>
                    ...
                    <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.6;">
                      Jika Anda tidak merasa meminta kode ini, abaikan email ini. 
                      Password Anda tidak akan diubah.
                    </p>
                  </td>
                </tr>
